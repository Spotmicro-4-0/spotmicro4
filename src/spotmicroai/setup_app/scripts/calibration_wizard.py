...
class CalibrationWizard:
    ...
    def capture_calibration_point(self, point_index: int, point: CalibrationPoint) -> bool:
        ...
        popup_win = self.create_popup_window()
        current_pulse = self.calibrator.servo.min_pulse
        ...
        try:
            while True:
                ...
                popup_win.addstr(8, 3, f"Min Pulse: {self.calibrator.servo.min_pulse} µs")
                popup_win.addstr(9, 3, f"Max Pulse: {self.calibrator.servo.max_pulse} µs")
    ...
    def calculate_and_save_parameters(self) -> None:
        ...
        self.calibrator.config_provider.set_servo_range(self.calibrator.servo_name, int(calculated_range))
