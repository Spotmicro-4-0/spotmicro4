...
ICON_PCA9685 = 2
ICON_GPIO = 3
ICON_REMOTE_CONTROLLER = 4
ICON_TEMPERATURE = 5
ICON_PROBLEM = 6
ICON_SUCCESS_REVERSE = 7
...
LCD_CURSOR_BEING_LINE_1 = 0x80
LCD_CURSOR_BEGIN_LINE_2 = 0xC0

# LCD write mode for character output
LCD_DECIMAL_WRITE_MODE = 0b00000001
