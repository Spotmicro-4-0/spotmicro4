...
class Config(metaclass=Singleton):
    ...
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_LEFT_PCA9685 = 'motion_controller[0].servos[0].rear_foot_left[0].pca9685'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_LEFT_CHANNEL = 'motion_controller[0].servos[0].rear_foot_left[0].channel'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_LEFT_MIN_PULSE = 'motion_controller[0].servos[0].rear_foot_left[0].min_pulse'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_LEFT_MAX_PULSE = 'motion_controller[0].servos[0].rear_foot_left[0].max_pulse'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_LEFT_REST_ANGLE = 'motion_controller[0].servos[0].rear_foot_left[0].rest_angle'
    ...
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_RIGHT_PCA9685 = 'motion_controller[0].servos[0].rear_foot_right[0].pca9685'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_RIGHT_CHANNEL = 'motion_controller[0].servos[0].rear_foot_right[0].channel'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_RIGHT_MIN_PULSE = 'motion_controller[0].servos[0].rear_foot_right[0].min_pulse'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_RIGHT_MAX_PULSE = 'motion_controller[0].servos[0].rear_foot_right[0].max_pulse'
    MOTION_CONTROLLER_SERVOS_REAR_FOOT_RIGHT_REST_ANGLE = 'motion_controller[0].servos[0].rear_foot_right[0].rest_angle'
    ...
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_LEFT_PCA9685 = 'motion_controller[0].servos[0].front_foot_left[0].pca9685'
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_LEFT_CHANNEL = 'motion_controller[0].servos[0].front_foot_left[0].channel'
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_LEFT_MIN_PULSE = 'motion_controller[0].servos[0].front_foot_left[0].min_pulse'
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_LEFT_MAX_PULSE = 'motion_controller[0].servos[0].front_foot_left[0].max_pulse'
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_LEFT_REST_ANGLE = 'motion_controller[0].servos[0].front_foot_left[0].rest_angle'
    ...
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_RIGHT_PCA9685 = 'motion_controller[0].servos[0].front_foot_right[0].pca9685'
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_RIGHT_CHANNEL = 'motion_controller[0].servos[0].front_foot_right[0].channel'
    MOTION_CONTROLLER_SERVOS_FRONT_FOOT_RIGHT_MIN_PULSE = 'motion_controller[0].servos[0].front_foot_right[0].min_pulse'
